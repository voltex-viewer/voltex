import { Sequence, MeasureInfo, PluginContext, RenderMode, SignalSource } from '@voltex-viewer/plugin-api';
...
export default (context: PluginContext): void => {
    ...
    const flameGraphSources: Array<{ name: string[]; source: SignalSource }> = [];
